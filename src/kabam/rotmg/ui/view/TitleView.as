...
public class TitleView extends Sprite
{
    ...
    private var mineText:TextFieldDisplayConcrete;
    ...
    public function makeMyText():TextFieldDisplayConcrete
    {
        var _local_1:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(15).setColor(0xC80A0A).setBold(true);
        _local_1.filters = [new DropShadowFilter(0, 0, 0)];
        return (_local_1);
    }
